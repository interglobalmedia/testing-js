...
const cov_2e1x39rbgn = function () {
    const path = '/Users/kdodds/Developer/jest-cypress-react-babel-webpack/src/utils.js';
    const hash = '11d29cc5894ffec96585bad5b940d9b13baa3ea3';
...
function getFormattedValue(value) {
    const language = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (cov_2e1x39rbgn.b[0][0]++ , 'en-US');
    cov_2e1x39rbgn.f[0]++;
    let formattedValue = (cov_2e1x39rbgn.s[0]++ , parseFloat(value).toLocaleString(language, {
        useGrouping: true,
        maximumFractionDigits: 6
    })); // Add back missing .0 in e.g. 12.0

    const match = (cov_2e1x39rbgn.s[1]++ , value.match(/\.\d*?(0*)$/));
    cov_2e1x39rbgn.s[2]++;
